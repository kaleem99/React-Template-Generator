...
import "./Header.scss";
import { FILTER_GITHUB_FILES } from "../Redux/actions";
function Header({ section, platform }) {
  ...
  return (
    <div className="Header">
      ...
      ></img>
      {platform !== "" && <h1 className="HeaderText">{section}</h1>}
      {section === "Github" && (
        <div
          style={{
            margin: "1px auto",
        ...
        >
          <input
            placeholder="search for a specific file name"
            onChange={(e) =>
              dispatch({
